...
import edu.upi.cs.drake.anithings.databinding.ActivityAnimeListBinding
...
class AnimeListActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DataBindingUtil.setContentView<ActivityAnimeListBinding>(this, R.layout.activity_anime_list)
